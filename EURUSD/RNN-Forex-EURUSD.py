...
dataset_train_ = pd.read_csv('../Resources/EURUSD-Training.csv')
training_set_ = dataset_train_.iloc[:, 1:2].values
...
dataset_test = pd.read_csv('../Resources/EURUSD-Test.csv')
